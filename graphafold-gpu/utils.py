...
if __name__ == "__main__":
    import sys
    idx_path, cmt_path = parse_dot2out(sys.argv[1])
    # get parent dir of file
    print(f"Index file: {os.path.dirname(idx_path)} | {idx_path}")
    print(f"Contact matrix file: {os.path.dirname(cmt_path)} | {cmt_path}")
# Example usage:
